...
// 不再使用硬编码的集合数据，改为从数据库动态获取

export const mockApiJobs: ApiScanJob[] = [
  {
    _id: "job-1",
    id: "job-1", // 兼容字段
    name: "域名扫描任务",
    collectionId: "ms-signup",
    parameterSetId: "default-domains",
    concurrency: 2,
    status: "completed",
    progress: 100,
    ...
    results: [
      {
        ...
        responseBody: '{"isEmailVerifiedTenant":true,"correlationId":"abc123"}',
        testResults: [
          {
            name: "验证租户邮箱状态",
            passed: true
      ...
      },
      {
        ...
        responseBody: '{"isEmailVerifiedTenant":false,"correlationId":"def456"}',
        testResults: [
          {
            name: "验证租户邮箱状态",
            passed: false,
            error: "Expected isEmailVerifiedTenant to equal true"
          }
        ],
        parameterValues: {
          "domain": "b.net"
      ...
      },
      {
        ...
        responseBody: '{"isEmailVerifiedTenant":true,"correlationId":"ghi789"}',
        testResults: [
          {
            name: "验证租户邮箱状态",
            passed: true
